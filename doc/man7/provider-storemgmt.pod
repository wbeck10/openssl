...
=item "key-alias" (B<OSSL_STORE_PARAM_KEY_ALIAS>) <UTF8 string>
=item "cert" (B<OSSL_STORE_PARAM_CERT>) <octet string>
=item "pub-key" (B<OSSL_STORE_PARAM_PUB_KEY>) <octet string>
=item "id" (B<OSSL_STORE_PARAM_ID>) <UTF8 string>
